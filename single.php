								 ...
								 ?>
									...
									<ul class="comment-list">
										<?php 
											...
											while($selrevr = mysqli_fetch_array($selrevres)) { 

										?>
										<li>
											<a class="pull-left" href="#"><img class="comment-avatar" src="images/quote/1.jpg" alt="" height="50" width="50"></a>
											<div class="comment-meta">
												<a href="#"><?php $selrevr['firstname']." ".$selrevr['lastname']; ?></a>
												<span>
												<em><?php $selrevr['timestamp']; ?></em>
												</span>
											</div>
											<!-- <div class="rating2">
							...
							?>
								...
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<div class="product-price">IMR <?php echo $relr['price']; ?>.00/<span></span></div>
									</div>
								</div>
