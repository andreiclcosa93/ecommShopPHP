		...
		<div class="content-blog content-account">
			...
			<table class="cart-table account-table table table-bordered">
				...
				?>
					<tr>
						<td>
							<a href="single.php?id=<php echo $wish['pid']; >"><?php echo $wishdr['name']; ?></a>
						</td>
						<td>
						    <?php echo $wishdr['price']; ?>
						</td>
						<td>
						    <?php echo $wishdr['timestamp']; ?>			
						</td>

                        <td>
                        <a href="delwishlist.php?id=<php echo $wish['id']; >">Delete</a>			
						</td>
